...
python3 "${script_dir}/../../postprocessing/collate.py" "s3://${bucket}/endeavor=${endeavor}/mutant-insertion-phenotype-differentiation/stage=1+what=generated/stint=${stint}/" 'a=interroot_phenotype_differentiation\+proc=[0-9]+\+replicate=[0-9]+\+.*\+thread=[0-9]+\+ext=\.csv' \
