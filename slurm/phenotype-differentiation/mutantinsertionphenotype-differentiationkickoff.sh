...
dishtiny/script/slurm_stoker_containerized_kickoff.sh "${BUCKET}" "${CONTAINER_TAG}" "${REPO_SHA}" "mutant-insertion-phenotype-differentiation~configpack%${CONFIGPACK}~series%${SERIES%% *}...~stint%${STINT}"
