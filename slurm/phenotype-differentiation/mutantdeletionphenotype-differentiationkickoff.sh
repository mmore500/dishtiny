...
################################################################################
echo
echo "running mutantdeletionphenotype-differentiationkickoff.sh"
echo "-----------------------------------"
################################################################################
...
second_subject_attrs: "deletion_mutate_on_load=1+"
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/mutant-deletion-phenotype-differentiation/stage=1+what=generated/stint=${STINT}/series=\${JUST_ONE_SERIES}/"
replicate: "\${REPLICATE}"
endeavor: "\${ENDEAVOR}"
stint: "${STINT}"
