...
second_competitor_attrs: "set_intermittent_writable_state_exchange_probability=${INTERMITTENT_P}+"
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/intermittent-writable-state-exchange-competitions/p=${INTERMITTENT_P}/stage=1+what=generated/stint=${STINT}/series=\${JUST_ONE_SERIES}/"
replicate: "\${REPLICATE}"
endeavor: "\${ENDEAVOR}"
stint: "${STINT}"
