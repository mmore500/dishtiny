...
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/immediatepredecessor-competitions-withbioticbackground-withmut/stage=1+what=generated/stint=${STINT}/series=\${JUST_ONE_SERIES}/"
replicate: "\${REPLICATE}"
endeavor: "\${ENDEAVOR}"
