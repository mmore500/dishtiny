...
################################################################################
echo
echo "running control-immediatepredecessorbattle-dosecorrected-withfocalstrainbaselinebioticbackground-withmutkickofff.sh"
echo "-------------------------------------------------------------------------"
################################################################################
...
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/control-immediatepredecessor-battles-dosecorrected-withfocalstrainbaselinebioticbackground-withmut/stage=1+what=generated/stint=${STINT}/series=\${JUST_ONE_SERIES}/"
replicate: "\${REPLICATE}"
endeavor: "\${ENDEAVOR}"
