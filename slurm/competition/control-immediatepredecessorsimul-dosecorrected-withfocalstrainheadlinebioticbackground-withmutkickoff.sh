...
################################################################################
echo
echo "running immediatepredecessorsimul-dosecorrected-withfocalstrainheadlinebioticbackground-withmutkickofff.sh"
echo "-------------------------------------------------------------------------"
################################################################################
...
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/control-immediatepredecessor-simuls-dosecorrected-withfocalstrainheadlinebioticbackground-withmut/stage=1+what=generated/stint=${STINT}/series=\${JUST_ONE_SERIES}/"
replicate: "\${REPLICATE}"
endeavor: "\${ENDEAVOR}"
