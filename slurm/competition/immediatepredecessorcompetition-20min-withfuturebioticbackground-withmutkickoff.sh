...
################################################################################
echo
echo "running immediatepredecessorcompetition-20min-withfuturebioticbackground-withmutkickofff.sh"
echo "-------------------------------------------------------------------------"
################################################################################
...
first_background_attrs: "filter_except_lowest_root+"
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/immediatepredecessor-competitions-20min-withfuturebioticbackground-withmut/stage=1+what=generated/stint=${STINT}/series=\${JUST_ONE_SERIES}/"
replicate: "\${REPLICATE}"
endeavor: "\${ENDEAVOR}"
