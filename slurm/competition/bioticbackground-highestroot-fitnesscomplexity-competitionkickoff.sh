...
BB_PE_NOPOUT_URI="s3://${BUCKET}/endeavor=\${ENDEAVOR}/genomes/stage=2+what=generated/stint=\${STINT}/series=${SERIES}/a=genome+bgpop=1+criteria=abundance_highest_roote+morph=jenga_phenotype_equivalent_nopout_with_biotic_background+proc=0+series=${SERIES}+stint=\${STINT}+thread=0+variation=master+ext=.json.gz"
