...
################################################################################
echo
echo "running immediatepredecessorsimul-dosecorrected-nodiversitymaintenance-withfocalstrainbaselinebioticbackground-withmutkickofff.sh"
echo "-------------------------------------------------------------------------"
################################################################################
...
for JUST_ONE_SERIES in ${SERIES}; do
  for REPLICATE in {0..19}; do
    ...
    FIRST_BACKGROUND="\${FIRST_COMPETITOR}"
...
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/control-immediatepredecessor-simuls-dosecorrected-nodiversitymaintenance-withfocalstrainbaselinebioticbackground-withmut/stage=1+what=generated/stint=${STINT}/series=\${JUST_ONE_SERIES}/"
replicate: "\${REPLICATE}"
endeavor: "\${ENDEAVOR}"
