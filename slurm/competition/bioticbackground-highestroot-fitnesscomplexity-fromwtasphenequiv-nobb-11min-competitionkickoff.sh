...
JOB_SCRIPT="\$( keyname pack \
  --a "wt_vs_variant_nobb" --variation "\${variation}" --ext ".slurm.sh" \
)"
...
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/variant-competitions-highestroot-nobb-11min/stage=3+what=generated/stint=\${STINT}/series=${SERIES}/"
replicate: 0
endeavor: \${ENDEAVOR}
stint: \${STINT}
series: ${SERIES}
...
echo
echo "STINT \${STINT}:"
echo "Generate WT vs WT (control) no BB Competition Runscripts"
echo "---------------------------------------------"
################################################################################
...
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/control-competitions-highestroot-nobb-11min/stage=3+what=generated/stint=\${STINT}/series=${SERIES}/"
replicate: \${replicate}
endeavor: \${ENDEAVOR}
stint: \${STINT}
series: ${SERIES}
