...
################################################################################
echo
echo "running bioticbackground-fitnesscomplexity-competitionkickoff.sh"
echo "-------------------------------------------------------------------------"
################################################################################
...
for p in *a=genome*morph=wildtype*variation=* ; do
  ...
  for retry in {1..20}; do
    aws s3 cp --quiet \
      "\${p}" \
      "s3://${BUCKET}/endeavor=\${ENDEAVOR}/genomes-bb/stage=2+what=generated/stint=\${STINT}/series=${SERIES}/\${f}" \
...
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/variant-competitions-backgroundbb/stage=3+what=generated/stint=\${STINT}/series=${SERIES}/"
replicate: 0
endeavor: \${ENDEAVOR}
stint: \${STINT}
series: ${SERIES}
...
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/variant-competitions-focalbb/stage=3+what=generated/stint=\${STINT}/series=${SERIES}/"
replicate: 0
endeavor: \${ENDEAVOR}
stint: \${STINT}
series: ${SERIES}
...
first_background_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/evolve/populations/stage=0+what=generated/stint=\${STINT}/series=${SERIES}/a=population+proc=0+series=${SERIES}+stint=\${STINT}+thread=0+variation=master+ext=.bin.xz"
first_background_attrs: "dose=2+filter_except_lowest_root+"
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/control-competitions-backgroundbb/stage=3+what=generated/stint=\${STINT}/series=${SERIES}/"
replicate: \${replicate}
endeavor: \${ENDEAVOR}
stint: \${STINT}
series: ${SERIES}
...
first_background_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/evolve/populations/stage=0+what=generated/stint=\${STINT}/series=${SERIES}/a=population+proc=0+series=${SERIES}+stint=\${STINT}+thread=0+variation=master+ext=.bin.xz"
first_background_attrs: "dose=2+filter_lowest_root+"
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/control-competitions-focalbb/stage=3+what=generated/stint=\${STINT}/series=${SERIES}/"
replicate: \${replicate}
endeavor: \${ENDEAVOR}
stint: \${STINT}
series: ${SERIES}
