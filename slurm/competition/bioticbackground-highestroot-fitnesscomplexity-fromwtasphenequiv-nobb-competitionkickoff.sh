...
echo
echo "STINT \${STINT}:"
echo "Generate WT vs Variant No BB Competition Runscripts"
echo "---------------------------------------------"
################################################################################
...
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/variant-competitions-highestroot-nobb/stage=3+what=generated/stint=\${STINT}/series=${SERIES}/"
replicate: 0
endeavor: \${ENDEAVOR}
stint: \${STINT}
series: ${SERIES}
...
JOB_SCRIPT="\$( keyname pack \
  --a "wt_vs_wt_nodbb" --replicate "\${replicate}" --ext ".slurm.sh" \
)"
...
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/control-competitions-highestroot-nobb/stage=3+what=generated/stint=\${STINT}/series=${SERIES}/"
replicate: \${replicate}
endeavor: \${ENDEAVOR}
stint: \${STINT}
series: ${SERIES}
