...
JOB_SCRIPT="\$( keyname pack \
  --a "externalcompetition_bg66_focalbb_true" --comparator_series "\${comparator_series}" --replicate "\${replicate}" --counter "\${counter}" --ext ".slurm.sh" \
)"
...
output_url: "s3://${BUCKET}/endeavor=\${ENDEAVOR}/external-competitions-bg66-focalbb-true/stage=1+what=generated/stint=\${STINT}/series=${SERIES}/"
replicate: \${replicate}
endeavor: \${ENDEAVOR}
stint: \${STINT}
series: ${SERIES}
