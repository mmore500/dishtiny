...
#SBATCH --job-name knockout-sharing     # you can give your job a name for easier identification (same as -J)
...
OUTPUT_DIR="/mnt/scratch/mmore500/dishtiny-knockout-replicate/${TREATMENT}+source=${SOURCE_SEED}+seed=${SEED}/"
CONFIG_DIR="/mnt/home/mmore500/dishtiny/knockout-replicate/config"
SOURCE_DIR="/mnt/home/mmore500/dishtiny/knockout-replicate/treat=standard+seed=${SOURCE_SEED}"
