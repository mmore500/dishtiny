...
OUTPUT_DIR="/mnt/scratch/mmore500/dishtiny-knockout-all-targeting/${TREATMENT}+source=${SOURCE_SEED}+seed=${SEED}/"
CONFIG_DIR="/mnt/home/mmore500/dishtiny/knockout-all-targeting/config"
SOURCE_DIR="/mnt/home/mmore500/dishtiny/knockout-all-targeting/treat=standard+seed=${SOURCE_SEED}"
