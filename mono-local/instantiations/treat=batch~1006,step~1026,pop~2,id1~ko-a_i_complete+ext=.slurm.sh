...
#SBATCH --job-name batch~1006,step~1026,pop~2,id1~ko-a_i_complete
...
OUTPUT_DIR="/mnt/scratch/mmore500/mono-local/treat=batch~1006,step~1026,pop~2,id1~ko-a_i_complete+seed=${SEED}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1006,step~1026,pop~2,id1~ko-a_i_complete+ext=.tar.gz"
