...
#SBATCH --job-name batch~1006,step~1026,pop~2,id1~ko-s_i_walkparameters
...
OUTPUT_DIR="/mnt/scratch/mmore500/mono-local/treat=batch~1006,step~1026,pop~2,id1~ko-s_i_walkparameters+seed=${SEED}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1006,step~1026,pop~2,id1~ko-s_i_walkparameters+ext=.tar.gz"
