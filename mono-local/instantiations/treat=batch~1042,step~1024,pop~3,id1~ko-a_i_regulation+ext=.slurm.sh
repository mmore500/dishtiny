...
#SBATCH --job-name batch~1042,step~1024,pop~3,id1~ko-a_i_regulation
...
OUTPUT_DIR="/mnt/scratch/mmore500/mono-local/treat=batch~1042,step~1024,pop~3,id1~ko-a_i_regulation+seed=${SEED}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1042,step~1024,pop~3,id1~ko-a_i_regulation+ext=.tar.gz"
