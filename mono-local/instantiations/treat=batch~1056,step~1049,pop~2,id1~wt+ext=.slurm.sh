...
#SBATCH --job-name batch~1056,step~1049,pop~2,id1~wt
...
OUTPUT_DIR="/mnt/scratch/mmore500/mono-local/treat=batch~1056,step~1049,pop~2,id1~wt+seed=${SEED}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1056,step~1049,pop~2,id1~wt+ext=.tar.gz"
