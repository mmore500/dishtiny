...
OUTPUT_DIR="/mnt/scratch/mmore500/mono-local/treat=batch~1006,step~1026,pop~2,id1~ko-p_i_apoptosis+seed=${SEED}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1006,step~1026,pop~2,id1~ko-p_i_apoptosis+ext=.tar.gz"
