...
EMP_BUILD_CONFIG(
  ...
  VALUE(MUTATION_RATE, double, 0.05, "What percentage of reproductions should be subject to mutations at all?"),
  ...
  VALUE(SNAPSHOT_FREQUENCY, size_t, 25000, "How often should we save data snapshots"),
  VALUE(SNAPSHOT_LENGTH, size_t, 20, "How long should snapshots last for?"),
  VALUE(RUN_LENGTH, size_t, 100100, "How many updates should we run the experiment for?"),
