...
EMP_BUILD_CONFIG(
  ...
  VALUE(SNAPSHOT_FREQUENCY, size_t, 10000, "How often should we save data snapshots"),
  VALUE(SNAPSHOT_LENGTH, size_t, 100, "How long should snapshots last for?"),
  VALUE(RUN_LENGTH, size_t, 50100, "How many updates should we run the experiment for?"),
