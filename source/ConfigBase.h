...
EMP_BUILD_CONFIG(
  ...
  VALUE(START_RESOURCE, double, 7.0, "How resource should a cell start with?; TODO unimplemented"),
  ...
  VALUE(ECOLOGICAL, bool, false, "Should we run in ecological mode?; TODO unimplemented"),
  ...
  VALUE(SNAPSHOT_FREQUENCY, size_t, 100000, "How often should we save data snapshots; TODO unimplemented"),
