...
EMP_BUILD_CONFIG(
  ...
  VALUE(RESOURCE_HARVESTED, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save resource harvested during a snapshot?"),
  ...
  VALUE(STOCKPILE, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save stockpiles during a snapshot?"),
  VALUE(LIVE, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save which cells are alive during a snapshot?"),
  VALUE(APOPTOSIS, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save apoptosis are dead during a snapshot?"),
  VALUE(TOTAL_CONTRIBUTE, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save total contribute during a snapshot?"),
  VALUE(PREV_CHAN, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save [prev chan] during a snapshot?"),
  ...
  VALUE(SPIKE_BROADCAST_TRAFFIC, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save spike broadcast traffic during a snapshot?"),
  VALUE(DEATH, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save death during a snapshot?"),
  VALUE(OUTGOING_CONNECTION_COUNT, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save outgoing connection counts during a snapshot?"),
  VALUE(FLEDGING_CONNECTION_COUNT, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save fledging connection counts during a snapshot?"),
  VALUE(INCOMING_CONNECTION_COUNT, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save incoming connection counts during a snapshot?"),

  VALUE(INBOX_ACTIVATION, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save inbox activations during a snapshot?"),
  VALUE(INBOX_TRAFFIC, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save inbox traffic during a snapshot?"),
  VALUE(TRUSTED_INBOX_TRAFFIC, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save trusted inbox traffic during a snapshot?"),
  VALUE(REP_OUTGOING, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save [rep outgoing] during a snapshot?"),
  VALUE(REP_INCOMING, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save [rep incoming] during a snapshot?"),
  VALUE(RESOURCE_CONTRIBUTED, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save resource contributed during a snapshot?"),
  VALUE(IN_RESISTANCE, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save in resistance during a snapshot?"),
  VALUE(OUT_RESISTANCE, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save out resistance during a snapshot?"),
  VALUE(HEIR, size_t, ENV_TRIG_FREQ_DEFAULT, "[NATIVE] How often should we save heirs during a snapshot?"),
)
