...
#SBATCH --job-name batch~1042,step~1024,pop~3,id1~wt,id2~ko-a_i_removeconnection
...
OUTPUT_DIR="/mnt/scratch/mmore500/match-local/treat=batch~1042,step~1024,pop~3,id1~wt,id2~ko-a_i_removeconnection/rep=${SLURM_ARRAY_TASK_ID}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1042,step~1024,pop~3,id1~wt,id2~ko-a_i_removeconnection+ext=.tar.gz"
