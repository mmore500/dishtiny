...
#SBATCH --job-name batch~1036,step~1042,id1~wt,id2~wt
...
OUTPUT_DIR="/mnt/scratch/mmore500/match-local/treat=batch~1036,step~1042,id1~wt,id2~wt/rep=${SLURM_ARRAY_TASK_ID}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1036,step~1042,id1~wt,id2~wt+ext=.tar.gz"
