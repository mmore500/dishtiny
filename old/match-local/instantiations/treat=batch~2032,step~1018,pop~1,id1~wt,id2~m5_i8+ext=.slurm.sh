...
#SBATCH --job-name batch~2032,step~1018,pop~1,id1~wt,id2~m5_i8
...
OUTPUT_DIR="/mnt/scratch/mmore500/match-local/treat=batch~2032,step~1018,pop~1,id1~wt,id2~m5_i8/rep=${SLURM_ARRAY_TASK_ID}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~2032,step~1018,pop~1,id1~wt,id2~m5_i8+ext=.tar.gz"
