...
python3 "${script_dir}/../script/collate.py" "s3://${bucket}/endeavor=${endeavor}/evolve/config-records/stage=0+what=generated/stint=${stint}/" 'series=[0-9]+/a=asconfigured\+proc=[0-9]+\+.*\+ext=\.csv' \
