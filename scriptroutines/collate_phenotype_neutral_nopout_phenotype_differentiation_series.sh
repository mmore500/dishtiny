...
python3 "${script_dir}/../script/collate.py" "s3://${bucket}/endeavor=${endeavor}/phenotype-neutral-nopout-phenotype-differentiation/stage=2+what=generated/stint=${stint}/" 'a=interroot_phenotype_differentiation\+proc=[0-9]+\+replicate=[0-9]+\+.*\+thread=[0-9]+\+ext=\.csv' \
