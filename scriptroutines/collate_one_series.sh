...
################################################################################
echo
echo "running collate_control_competition_series.sh"
echo "---------------------------------------------"
################################################################################
...
"${script_dir}/collate_control_competition_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
  || echo "collate_control_competition_series.sh failed"

"${script_dir}/collate_evolve_config_records_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
  || echo "collate_evolve_config_records_series.sh failed"

"${script_dir}/collate_evolve_statistics_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
  || echo "collate_evolve_statistics_series.sh failed"

"${script_dir}/collate_genome_statistics_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
...
"${script_dir}/collate_mutant_deletion_competition_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
  || echo "collate_mutant_deletion_competition_series.sh failed"

"${script_dir}/collate_mutant_deletion_phenotype_differentiation_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
  || echo "collate_mutant_deletion_phenotype_differentiation_series.sh failed"

"${script_dir}/collate_mutant_insertion_competition_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
  || echo "collate_mutant_insertion_competition_series.sh failed"

"${script_dir}/collate_mutant_phenotype_differentiation_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
...
"${script_dir}/collate_mutant_point_competition_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
...
"${script_dir}/collate_mutating_competition_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
...
for messaging_target in "intra" "inter"; do
  ...
  "${script_dir}/collate_selfsend_competition_series.sh" \
    "${bucket}" "${endeavor}" "${stint}" "${messaging_target}"\
    || echo "collate_selfsend_competition_series.sh failed"
done

"${script_dir}/collate_strain_competition_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
  || echo "collate_strain_competition_series.sh failed"

"${script_dir}/collate_variant_competition_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
  || echo "collate_variant_competition_series.sh failed"

"${script_dir}/collate_wildtype_doubling_time_series.sh" \
  "${bucket}" "${endeavor}" "${stint}" \
