#pragma once
#ifndef DISH2_SERVICES_THREADLOCAL_STINTDIVERSITYMAINTENANCESERVICE_HPP_INCLUDE
#define DISH2_SERVICES_THREADLOCAL_STINTDIVERSITYMAINTENANCESERVICE_HPP_INCLUDE
...
#include "../introspection/get_stint_root_id_counts.hpp"
#include "../world/iterators/LiveCellIterator.hpp"
#include "../world/iterators/StintRootIDValWrapper.hpp"
...
struct StintDiversityMaintenanceService {
  ...
  static void DoService( ThreadWorld& thread_world, const size_t ) {
    ...
    const dish2::LogScope guard{
      "stint diversity maintentance service", "TODO", 3
    };

    auto& population = thread_world.population;

    const auto stint_root_id_counts
      = dish2::get_stint_root_id_counts( thread_world );

    const size_t threshold_count = (
      dish2::cfg.STINT_DIVERSITY_MAINTENANCE_PREVALENCE()
    ...
    uitsl::for_each(
      begin, end,
      dish2::StintRootIDValWrapper{ begin },
      [&stint_root_id_counts, threshold_count](
        auto& cell, const size_t stint_root_id
      ){
...
#endif // #ifndef DISH2_SERVICES_THREADLOCAL_STINTDIVERSITYMAINTENANCESERVICE_HPP_INCLUDE
