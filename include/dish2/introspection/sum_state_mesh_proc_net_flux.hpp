#pragma once
#ifndef DISH2_INTROSPECTION_SUM_STATE_MESH_PROC_NET_FLUX_HPP_INCLUDE
#define DISH2_INTROSPECTION_SUM_STATE_MESH_PROC_NET_FLUX_HPP_INCLUDE
...
size_t sum_state_mesh_proc_net_flux(
  ...
  return std::accumulate(
    ...
    [](const size_t accumulator, const auto& in){
      ...
      else return accumulator + in.GetNetFlux();
    }
  );
...
#endif // #ifndef DISH2_INTROSPECTION_SUM_STATE_MESH_PROC_NET_FLUX_HPP_INCLUDE
