#pragma once
#ifndef DISH2_INTROSPECTION_GET_ROOT_ID_FOCAL_PREVALENCE_HPP_INCLUDE
#define DISH2_INTROSPECTION_GET_ROOT_ID_FOCAL_PREVALENCE_HPP_INCLUDE
...
double get_root_id_focal_prevalence(
  ...
  if ( dish2::no_live_cells_with_focal_root_ids<Spec>( world ) ) {
...
#endif // #ifndef DISH2_INTROSPECTION_GET_ROOT_ID_FOCAL_PREVALENCE_HPP_INCLUDE
