#pragma once
#ifndef DISH2_LOAD_INNOCULUM_ATTR_HANDLERS_APPLY_DELETION_MUTATE_ON_LOAD_HPP_INCLUDE
#define DISH2_LOAD_INNOCULUM_ATTR_HANDLERS_APPLY_DELETION_MUTATE_ON_LOAD_HPP_INCLUDE
...
void apply_deletion_mutate_on_load(
  ...
  if ( attrs.count("deletion_mutate_on_load") ) {
    ...
    if ( should_announce ) dish2::log_msg(
      "applying ", num_muts, " deletion mutations to genome ",
...
#endif // #ifndef DISH2_LOAD_INNOCULUM_ATTR_HANDLERS_APPLY_DELETION_MUTATE_ON_LOAD_HPP_INCLUDE
