#pragma once
#ifndef DISH2_LOAD_INNOCULUM_ATTR_HANDLERS_APPLY_MUTATE_ON_LOAD_HPP_INCLUDE
#define DISH2_LOAD_INNOCULUM_ATTR_HANDLERS_APPLY_MUTATE_ON_LOAD_HPP_INCLUDE
...
void apply_mutate_on_load(
  ...
  if ( attrs.count("mutate_on_load") ) {
    ...
    if ( should_announce ) dish2::log_msg(
      " applying ", num_muts, " mutations to genome ", attrs.at("root_id"),
      " from ", path
    );
...
#endif // #ifndef DISH2_LOAD_INNOCULUM_ATTR_HANDLERS_APPLY_MUTATE_ON_LOAD_HPP_INCLUDE
