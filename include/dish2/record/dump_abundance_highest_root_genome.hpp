...
#include "make_filename/make_dump_abundance_highest_root_genome_filename.hpp"
...
bool dump_abundance_highest_root_genome( const dish2::ThreadWorld< Spec >& world ) {
  ...
  const auto [genome, count]
    = dish2::get_highest_root_prevalent_coding_genotype_genome<Spec>( world );
...
#endif // #ifndef DISH2_RECORD_DUMP_ABUNDANCE_HIGHEST_ROOT_GENOME_HPP_INCLUDE
