#pragma once
#ifndef DISH2_RECORD_MAKE_FILENAME_MAKE_KIN_CONFLICT_STATISTICS_FILENAME_HPP_INCLUDE
#define DISH2_RECORD_MAKE_FILENAME_MAKE_KIN_CONFLICT_STATISTICS_FILENAME_HPP_INCLUDE
...
std::string make_kin_conflict_statistics_filename() {
  auto keyname_attributes = emp::keyname::unpack_t{
    {"a", "kin_conflict_statistics"},
...
#endif // #ifndef DISH2_RECORD_MAKE_FILENAME_MAKE_KIN_CONFLICT_STATISTICS_FILENAME_HPP_INCLUDE
