...
std::string make_in_progress_jenga_nopout_genome_filename(
  ...
  auto keyname_attributes = emp::keyname::unpack_t{
    {"a", "genome"},
    {"morph", "in_progress_jenga_nopout"},
    {"variation", emp::to_string("num_ops%", num_ops)},
  ...
  dish2::log_msg(
    "in_progress_jenga_nopout", " background population size ",
...
#endif // #ifndef DISH2_RECORD_MAKE_FILENAME_MAKE_IN_PROGRESS_JENGA_NOPOUT_GENOME_FILENAME_HPP_INCLUDE
