#pragma once
#ifndef DISH2_RECORD_MAKE_FILENAME_MAKE_JENGA_DIVERGENCE_UPDATES_FILENAME_HPP_INCLUDE
#define DISH2_RECORD_MAKE_FILENAME_MAKE_JENGA_DIVERGENCE_UPDATES_FILENAME_HPP_INCLUDE
...
std::string make_jenga_divergence_updates_filename(
  ...
  auto keyname_attributes = emp::keyname::unpack_t{
    {"a", "jenga_nopout_divergence_updates"},
    {
  ...
  dish2::log_msg(
    "jenga_nopout_divergence_updates ",
    criteria,
...
#endif // #ifndef DISH2_RECORD_MAKE_FILENAME_MAKE_JENGA_DIVERGENCE_UPDATES_FILENAME_HPP_INCLUDE
