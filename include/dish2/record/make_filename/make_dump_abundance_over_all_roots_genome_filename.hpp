...
std::string make_dump_abundance_over_all_roots_genome_filename(
  const size_t count,
  ...
  auto keyname_attributes = emp::keyname::unpack_t{
    {"a", "genome"},
    {"criteria", "abundance_over_all_roots"},
...
#endif // #ifndef DISH2_RECORD_MAKE_FILENAME_MAKE_DUMP_ABUNDANCE_OVER_ALL_ROOTS_GENOME_FILENAME_HPP_INCLUDE
