...
namespace internal::neighbor_kin_group_id_artist {
...
template<
  ...
  typename NeighborKinGroupIDViewGetter
    =dish2::NeighborKinGroupIDViewGetter<dish2::Spec>
>
class NeighborKinGroupIDViewArtist
: public internal::neighbor_kin_group_id_artist::parent_t<
  IsAliveGetter,
  KinGroupIDGetter,
  NeighborKinGroupIDViewGetter
> {

  using parent_t = internal::neighbor_kin_group_id_artist::parent_t<
    IsAliveGetter,
    KinGroupIDGetter,
    NeighborKinGroupIDViewGetter
    >;
...
public:
  ...
  static std::string GetName() { return "Neighbor Kin Group ID"; }
