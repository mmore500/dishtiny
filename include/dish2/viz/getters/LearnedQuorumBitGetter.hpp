#pragma once
#ifndef DISH2_VIZ_GETTERS_LEARNEDQUORUMBITGETTER_HPP_INCLUDE
#define DISH2_VIZ_GETTERS_LEARNEDQUORUMBITGETTER_HPP_INCLUDE
...
public:
  ...
  const value_type Get(
    ...
    return thread_world.get().GetCell(
      cell_idx
    ).cardinals[ cardinal_idx ].cardinal_quorum_state.GetLearnedBit(
      lev, 0
    );
  }
...
#endif // #ifndef DISH2_VIZ_GETTERS_LEARNEDQUORUMBITGETTER_HPP_INCLUDE
