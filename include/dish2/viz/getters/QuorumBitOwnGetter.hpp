#pragma once
#ifndef DISH2_VIZ_GETTERS_QUORUMBITOWNGETTER_HPP_INCLUDE
#define DISH2_VIZ_GETTERS_QUORUMBITOWNGETTER_HPP_INCLUDE
...
public:
  ...
  const value_type Get(
    ...
    return thread_world.get().GetCell(
      cell_idx
    ).cell_quorum_state.GetOwnQuorumBit( lev, 0 );
  }
...
#endif // #ifndef DISH2_VIZ_GETTERS_QUORUMBITOWNGETTER_HPP_INCLUDE
