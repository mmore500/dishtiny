...
#SBATCH --job-name ko-all-complete
...
OUTPUT_DIR="/mnt/scratch/mmore500/ko-all-complete/seed=${SEED}"
CONFIG_DIR="/mnt/home/mmore500/dishtiny/ko-all-complete/"
