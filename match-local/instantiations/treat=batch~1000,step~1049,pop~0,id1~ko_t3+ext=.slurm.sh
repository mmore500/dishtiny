...
#SBATCH --job-name batch~1000,step~1049,pop~0,id1~ko_t3
...
OUTPUT_DIR="/mnt/scratch/mmore500/match-local/treat=batch~1000,step~1049,pop~0,id1~ko_t3/rep=${SLURM_ARRAY_TASK_ID}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1000,step~1049,pop~0,id1~ko_t3+ext=.tar.gz"
