...
#SBATCH --job-name batch~1042,step~1024,pop~3,id1~wt,id2~ki-a_i_nop
...
OUTPUT_DIR="/mnt/scratch/mmore500/match-local/treat=batch~1042,step~1024,pop~3,id1~wt,id2~ki-a_i_nop/rep=${SLURM_ARRAY_TASK_ID}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1042,step~1024,pop~3,id1~wt,id2~ki-a_i_nop+ext=.tar.gz"
