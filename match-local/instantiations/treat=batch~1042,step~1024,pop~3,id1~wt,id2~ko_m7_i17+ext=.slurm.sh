...
#SBATCH --job-name batch~1042,step~1024,pop~3,id1~wt,id2~ko_m7_i17
...
OUTPUT_DIR="/mnt/scratch/mmore500/match-local/treat=batch~1042,step~1024,pop~3,id1~wt,id2~ko_m7_i17/rep=${SLURM_ARRAY_TASK_ID}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1042,step~1024,pop~3,id1~wt,id2~ko_m7_i17+ext=.tar.gz"
