...
#SBATCH --job-name batch~1042,step~1024,pop~3,id1~wt,id2~ko_sm15_i0,1,3,4,6,8,9,11
...
OUTPUT_DIR="/mnt/scratch/mmore500/match-local/treat=batch~1042,step~1024,pop~3,id1~wt,id2~ko_sm15_i0,1,3,4,6,8,9,11/rep=${SLURM_ARRAY_TASK_ID}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1042,step~1024,pop~3,id1~wt,id2~ko_sm15_i0,1,3,4,6,8,9,11+ext=.tar.gz"
