...
#SBATCH --job-name batch~1000,step~1049,pop~0,id1~ko_f2_i8
...
OUTPUT_DIR="/mnt/scratch/mmore500/match-local/treat=batch~1000,step~1049,pop~0,id1~ko_f2_i8/rep=${SLURM_ARRAY_TASK_ID}"
...
mkdir -p ${OUTPUT_DIR}
cd ${OUTPUT_DIR}
tar -xvf "${CONFIG_DIR}/treat=batch~1000,step~1049,pop~0,id1~ko_f2_i8+ext=.tar.gz"
