...
breathe_projects = {
    "Santiago Rodriguez Papa": "./doxyoutput/xml"
}
breathe_default_project = "Santiago Rodriguez Papa"
...
project = u'Header-Only PCA'
copyright = u"2020, Santiago Rodriguez Papa"
author = u"Santiago Rodriguez Papa"
...
htmlhelp_basename = 'header-only-pcadoc'
...
latex_documents = [
    (master_doc, 'header-only-pca.tex',
     u'Header-Only PCA Documentation',
     u'Santiago Rodriguez Papa', 'manual'),
]
