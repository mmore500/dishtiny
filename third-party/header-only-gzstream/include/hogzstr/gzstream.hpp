// adapted from https://gist.githubusercontent.com/piti118/1508048/raw/1a509301db533e9661342b7d4225a32c9240eae6/gzstream.h
// ============================================================================
...
public:
    ...
    igzstream( const std::string& name, int open_mode = std::ios::in)
        : igzstream( name.c_str(), open_mode) {}
