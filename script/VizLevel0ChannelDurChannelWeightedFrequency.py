...
sns.tsplot(df, time='ch0_dur', unit = "seed", value='channel_weighted_freq',ax=ax,title="Duration of Level 1 Channels",xlabel="Updates",ylabel="Log Per-Channel Frequency")
