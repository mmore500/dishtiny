...
lab = "First-level Resource Sharing and Zero-level Altruistic Suicide"
ax.set_title(lab)
ax.set_xlabel("Dominant Genotype $P_1$")
ax.set_ylabel("Dominant Genotype $M_0$")
...
lab = "Second-level Resource Sharing and Zero-level Altruistic Suicide"
ax.set_title(lab)
...
ax.set_ylabel("Population Mean $M_0$")
...
ax.set_title(lab)
ax.set_ylabel("Dominant Genotype $P_2$")
ax.set_xlabel("Dominant Genotype $E_1$")
