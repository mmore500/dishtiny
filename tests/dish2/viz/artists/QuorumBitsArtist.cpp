...
TEST_CASE("Test QuorumBitsArtist") {
  ...
  dish2::QuorumBitsArtist<> artist{ tw };

  artist.Draw( canvas );

  canvas.SavePNG( "QuorumBitsArtist.png" );

  emscripten_run_script(R"(
    var exec = require('child_process').exec;

    setTimeout(function() { exec(
      'cmp -s QuorumBitsArtist.png assets/QuorumBitsArtist.png',
