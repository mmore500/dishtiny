...
#SBATCH --mem=24G
#SBATCH --job-name treat=standard     # you can give your job a name for easier identification (same as -J)
...
OUTPUT_DIR="/mnt/scratch/mmore500/dishtiny/${TREATMENT}+seed=${SEED}"
